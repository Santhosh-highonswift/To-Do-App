        ...
        >
          ...
          <div className="relative">
            <motion.input
              ...
              className="block w-full rounded-xl border border-gray-200 px-4 py-3 pl-11 pr-11 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 text-gray-700 transition-all bg-white"
